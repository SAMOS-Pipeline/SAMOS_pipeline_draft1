...
\begin{itemize}
  \item \code{Slit$\_$id.py}
  \item \code{OutlineSlits}
  \item \code{NormDivFlats}
  \item \code{FlatNorm.py}
  \item \code{Overscan.py}
  \item \code{OverscanAndTrim}
  \item \code{SAMOSHelpers.py}
  \item \code{WhichFITSFiles}
  \item \code{cleaner.sh}
  \item \code{LMask(1,2)$\_$y$\_$coords$\_$c1.txt}
  \item LDSS3-directory containing test data
\end{itemize}
